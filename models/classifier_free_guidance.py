...
Implements the channel-concatenation approach from Ho & Salimans 2022:
...
Components:
    1. ClassConditionedUNet  — training-time wrapper that concatenates class
       conditioning to the UNet input and handles unconditional dropout
    2. ClassifierFreeGuidanceWrapper — sampling-time wrapper that performs
       dual forward passes (conditional + unconditional) and applies CFG
    3. create_conditioned_unet — factory function for convenient construction
"""
import torch
